#ifndef OPEN_BLAS_HPP_BY_TANMAY
#define OPEN_BLAS_HPP_BY_TANMAY
...
void addProductOpenBlas(Matrix<__num> &Mat1, Matrix<__num> &Mat2, Matrix<__num> &Mat3){
    ...
    A = (double*) malloc(Mat1.n * Mat1.m * sizeof(double));
    B = (double*) malloc(Mat2.n * Mat2.m * sizeof(double));
    C = (double*) malloc(Mat3.n * Mat3.m * sizeof(double));
